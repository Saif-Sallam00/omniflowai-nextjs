  ...
  return (
    <main className="flex min-h-screen flex-col overflow-x-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <HomeHero
        ...
        subhead="ذكاء اصطناعي، تسويق، برمجيات، أتمتة — لا نبني إلا ما يدعمه التشخيص. ننظر قبل أن نلمس، ليلائم ما نبنيه طريقة عمل أعمالك فعلاً."
        primaryCtaLabel="احجز مكالمة استراتيجية"
        secondaryCtaLabel="استعرض أعمالنا"
