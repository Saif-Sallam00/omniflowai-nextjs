...
export function generateMetadata() {
  return buildPageMetadata({
    ...
    language: "ar",
    title: "المقالات",
    description: "ملاحظات عملية حول الذكاء الاصطناعي والتسويق والأنظمة التي تربطها.",
  });
}
      ...
      <section className="relative overflow-hidden py-16 md:py-20">
        ...
        <div className="relative mx-auto max-w-6xl px-6 md:px-8">
          ...
          <h1 className="max-w-[20ch] font-display text-3xl font-bold leading-[1.1] tracking-tight text-white sm:text-4xl md:text-5xl">
            ملاحظات عملية حول الذكاء الاصطناعي والتسويق والأنظمة التي تربطها.
          </h1>
          <p className="mt-5 max-w-[62ch] leading-relaxed text-slate-400">
            ملاحظات ميدانية من الأنظمة التي نبنيها — ما نتعلّمه ونختبره وننجزه لعملائنا.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6 md:px-8">
          {articleList.length === 0 ? (
            <p className="max-w-[52ch] leading-relaxed text-slate-400">
              لا توجد مقالات منشورة بعد. الأولى في الطريق.
            </p>
          ) : (
